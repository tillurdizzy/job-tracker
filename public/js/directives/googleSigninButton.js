//Sets attributes for the google signin button and paints it in the authenticate.html view
myApp.directive('googleButton',['googleClientID', function(googleClientID) {
  return {
    restrict: 'A',
    ...
    link: function(scope, ele, attrs) {
      ...
      // Set the clientid
      attrs.$set('data-clientid', googleClientID);
      // build scope urls
